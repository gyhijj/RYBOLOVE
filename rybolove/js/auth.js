        ...
        profileIcon.addEventListener('click', function (e) {
            ...
            if (isLoggedIn()) {
                if (currentPage === 'index.html') {
                    // Если это главная страница, перенаправляем на pages
                    window.location.href = 'pages/profile.html'; 
                } else {
                    // На остальных страницах перенаправляем на профиль
                    window.location.href = 'profile.html';
                }
            } else {
                // Если пользователь не авторизован, показываем модальное окно для входа
